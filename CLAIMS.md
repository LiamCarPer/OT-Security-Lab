...
| Item | Status | Notes |
| :--- | :--- | :--- |
| HMI default credentials | Planned | Scada-LTS ships `admin/admin`; provisioned credential change is roadmap (HMI-3.2, `hardening/HARDENING_CHECKLIST.md`). |
| HMI login-failure detection | Planned | Only Modbus exception detection exists today (HMI-3.3). |
