...
| :--- | :--- | :--- | :--- |
| 1 | Unauthorized Modbus write to control logic (T0831) | EXTREME | Gateway allow-lists (Modbus restricted to HMI 172.22.0.10), UNAUTHORIZED_MODBUS_WRITE detection, IR playbook |
